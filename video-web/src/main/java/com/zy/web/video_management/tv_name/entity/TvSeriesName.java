...
/**
 *
 * @TableName tv_series_name
 */
@TableName(value ="tv_series_name")
@Data
public class TvSeriesName implements Serializable {
    /**
     * 电视剧id
     */
    @TableId(value = "tvid", type = IdType.AUTO)
    private Long tvid;
    ...
    public boolean equals(Object that) {
        ...
        TvSeriesName other = (TvSeriesName) that;
        return (this.getTvid() == null ? other.getTvid() == null : this.getTvid().equals(other.getTvid()))
